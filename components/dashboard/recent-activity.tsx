  ...
  const fetchRecentActivity = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.log('Recent Activity - All tasks:', allTasks.length);
        console.log('Recent Activity - Completed tasks found:', recent.length);
        console.log('Recent Activity - Sample completed tasks:', recent.slice(0, 2));
